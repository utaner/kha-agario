...
var Entity = function(x,y,size) {
	this.speed = 2;
	this.size = size;
	this.position = new kha_math_Vector2(x - size / 2,y - size / 2);
...
Entity.prototype = {
	...
	,size: null
	,render: function(gp) {
		kha_graphics2_GraphicsExtension.fillCircle(gp,this.position.x,this.position.y,this.size);
	}
	,update: function() {
...
var Food = function(x,y,size) {
	...
	this.size = size;
	var rand_color = [-1,kha__$Color_Color_$Impl_$.fromBytes(66,165,245),kha__$Color_Color_$Impl_$.fromBytes(255,213,79),kha__$Color_Color_$Impl_$.fromBytes(186,104,200),kha__$Color_Color_$Impl_$.fromBytes(121,85,72),kha__$Color_Color_$Impl_$.fromBytes(169,204,227),kha__$Color_Color_$Impl_$.fromBytes(245,183,177)];
	this.food_color = rand_color[Std.random(rand_color.length)];
};
$hxClasses["Food"] = Food;
Food.__name__ = true;
Food.__super__ = Entity;
Food.prototype = $extend(Entity.prototype,{
	food_color: null
	,update: function() {
	}
	,render: function(gp) {
		gp.set_color(this.food_color);
		Entity.prototype.render.call(this,gp);
	}
	,__class__: Food
});
var Game = function() {
	this.MAP_HEIGHT = 6000;
	this.MAP_WIDTH = 6000;
	this.height = 768;
	this.width = 1024;
	this._foods = [];
	this.startingRadius = 32;
	this._player = new Player(2500,2500,32);
	this._camera = new muz_Camera(2500,2500);
	var _g = 0;
	while(_g < 1000) {
		var i = _g++;
		var food = new Food(this.randomRangeFloat(0,this.MAP_WIDTH),this.randomRangeFloat(0,this.MAP_HEIGHT),this.randomRangeFloat(8,20));
...
Game.prototype = {
	...
	,update: function() {
		...
		while(_g < _g1.length) {
			...
			++_g;
			v.update();
			if(this._player.eats(v)) {
				HxOverrides.remove(this._foods,v);
				var sum = Math.PI * this._player.size * this._player.size + Math.PI * v.size * v.size;
				this._player.size = Math.sqrt(sum / Math.PI);
				var newzoom = this.startingRadius / this._player.size;
				this._camera.zoom = this.lerp(this._camera.zoom,newzoom,0.1);
			}
		}
		this._player.willgo_x = this.mouseX - (this.width / 2 - this._player.position.x + 32);
		this._player.willgo_y = this.mouseY - (this.height / 2 - this._player.position.y + 32);
		this._camera.lookAt(this._player);
	}
	,render: function(framebuffer) {
		var gp = framebuffer.get_g2();
		gp.begin();
		this._camera.set(gp);
		var _g = 0;
		var _g1 = this._foods;
...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "Agario_Clone", width : Main.WIDTH, height : Main.HEIGHT, samplesPerPixel : Main.SPP},function() {
		kha_Assets.loadEverything(function() {
			var Game1 = new Game();
			kha_Scheduler.addTimeTask($bind(Game1,Game1.update),0,0.016666666666666666);
			kha_System.notifyOnRender($bind(Game1,Game1.render));
		});
	});
};
Math.__name__ = true;
...
Player.prototype = $extend(Entity.prototype,{
	...
	,eats: function(food) {
		var distanceX = this.position.x - food.position.x;
		var distanceY = this.position.y - food.position.y;
		var total = Math.sqrt(distanceX * distanceX + distanceY * distanceY);
		var res = total + food.size <= this.size;
		return res;
	}
	,render: function(gp) {
		gp.set_color(kha__$Color_Color_$Impl_$.fromBytes(239,83,80));
		Entity.prototype.render.call(this,gp);
	}
	,__class__: Player
});
...
kha_Shaders.init = function() {
	...
	var blobs1 = [];
	var data2 = Reflect.field(kha_Shaders,"painter_colored_fragData" + 0);
	var bytes2 = haxe_Unserializer.run(data2);
	blobs1.push(kha_internal_BytesBlob.fromBytes(bytes2));
	var data3 = Reflect.field(kha_Shaders,"painter_colored_fragData" + 1);
	var bytes3 = haxe_Unserializer.run(data3);
	blobs1.push(kha_internal_BytesBlob.fromBytes(bytes3));
	kha_Shaders.painter_colored_frag = new kha_graphics4_FragmentShader(blobs1,["painter-colored.frag.essl","painter-colored-webgl2.frag.essl"]);
	var blobs2 = [];
	...
	var data5 = Reflect.field(kha_Shaders,"painter_text_fragData" + 1);
	var bytes5 = haxe_Unserializer.run(data5);
	blobs2.push(kha_internal_BytesBlob.fromBytes(bytes5));
	kha_Shaders.painter_text_frag = new kha_graphics4_FragmentShader(blobs2,["painter-text.frag.essl","painter-text-webgl2.frag.essl"]);
	var blobs3 = [];
	...
	kha_Shaders.painter_image_frag = new kha_graphics4_FragmentShader(blobs3,["painter-image.frag.essl","painter-image-webgl2.frag.essl"]);
	var blobs4 = [];
...
var muz_Camera = function(x,y) {
	this.zoom = 1;
	this.camera_x = x;
	this.camera_y = y;
};
$hxClasses["muz.Camera"] = muz_Camera;
muz_Camera.__name__ = true;
muz_Camera.prototype = {
	camera_x: null
	,camera_y: null
	,trans: null
	,zoom: null
	,set: function(graphics) {
		...
		var _this__12 = 0;
		var _this__22 = 1;
		var m__00 = _this__00 * trans._00 + _this__10 * trans._01 + _this__20 * trans._02;
		var m__10 = _this__00 * trans._10 + _this__10 * trans._11 + _this__20 * trans._12;
		var m__20 = _this__00 * trans._20 + _this__10 * trans._21 + _this__20 * trans._22;
		var m__01 = _this__01 * trans._00 + _this__11 * trans._01 + _this__21 * trans._02;
		var m__11 = _this__01 * trans._10 + _this__11 * trans._11 + _this__21 * trans._12;
		var m__21 = _this__01 * trans._20 + _this__11 * trans._21 + _this__21 * trans._22;
		var m__02 = _this__02 * trans._00 + _this__12 * trans._01 + _this__22 * trans._02;
		var m__12 = _this__02 * trans._10 + _this__12 * trans._11 + _this__22 * trans._12;
		var m__22 = _this__02 * trans._20 + _this__12 * trans._21 + _this__22 * trans._22;
		trans._00 = m__00;
		trans._10 = m__10;
		trans._20 = m__20;
		trans._01 = m__01;
		...
		var _this__001 = 1;
		var _this__101 = 0;
		var _this__201 = 512. - this.camera_x;
		var _this__011 = 0;
		var _this__111 = 1;
		var _this__211 = 384. - this.camera_y;
		var _this__021 = 0;
		var _this__121 = 0;
		var _this__221 = 1;
		var m__001 = _this__001 * trans._00 + _this__101 * trans._01 + _this__201 * trans._02;
		var m__101 = _this__001 * trans._10 + _this__101 * trans._11 + _this__201 * trans._12;
		var m__201 = _this__001 * trans._20 + _this__101 * trans._21 + _this__201 * trans._22;
		var m__011 = _this__011 * trans._00 + _this__111 * trans._01 + _this__211 * trans._02;
		var m__111 = _this__011 * trans._10 + _this__111 * trans._11 + _this__211 * trans._12;
		var m__211 = _this__011 * trans._20 + _this__111 * trans._21 + _this__211 * trans._22;
		var m__021 = _this__021 * trans._00 + _this__121 * trans._01 + _this__221 * trans._02;
		var m__121 = _this__021 * trans._10 + _this__121 * trans._11 + _this__221 * trans._12;
		var m__221 = _this__021 * trans._20 + _this__121 * trans._21 + _this__221 * trans._22;
		trans._00 = m__001;
		trans._10 = m__101;
		trans._20 = m__201;
		trans._01 = m__011;
		...
		trans._12 = m__121;
		trans._22 = m__221;
		graphics.setTransformation(trans);
	...
	,lookAt: function(obj) {
		this.camera_x = (obj.position.x + obj.size * 0.5) * this.zoom;
		this.camera_y = (obj.position.y + obj.size * 0.5) * this.zoom;
	}
	,unset: function(graphics) {
		graphics.popTransformation();
	}
	,__class__: muz_Camera
};
